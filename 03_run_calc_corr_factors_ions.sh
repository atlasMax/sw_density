...
SESSION_NAME="corr_facs_i"

# Set a path for your log file
LOG_FILE="logs/correction_factors_ions_log_$(date +%Y%m%d_%H%M%S).txt"

# Command to run
CMD="python -u run_correction_factors_i_parallel.py > $LOG_FILE 2>&1"
